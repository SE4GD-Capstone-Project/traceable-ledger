...
from .views import ProductViewSet,SubPartViewSet,ProductSubpartViewSet,SubManufacturerViewSet, SustainabilityMetricsViewSet
...
router.register(r'sustainability-metrics', SustainabilityMetricsViewSet)
